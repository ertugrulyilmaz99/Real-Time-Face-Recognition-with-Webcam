...
class CasperFaceID:
    ...
    # A method which adds a person to database
    def addPerson(self):
    ...
    # A method which recognize a person by using database
    def detect(self):
        ...
        while True:
            ...
            for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
                ...
                if matches[best_match_index]:
                    ...
                    # If distance between them is greater than 0.50 that person can open the door
    ...
    # A method which removes a person from database
    def remove(self,selectedFile):
        # Remove the person whose location comes from the parameter
